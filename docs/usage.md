...
- `enable_advanced_formula_enrichment` (bool): If enabled, perform advanced formula enhancement using OCR for better formula recognition. Defaults to false.
- `enable_character_encoding_fix` (bool): If enabled, perform character encoding fix for corrupted text characters. Defaults to false.
