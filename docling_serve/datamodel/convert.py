...
class ConvertDocumentsRequestOptions(ConvertDocumentsOptions):
    ...
    enable_advanced_formula_enrichment: Annotated[
        bool,
        Field(
            description="Enable advanced formula enhancement using OCR for better formula recognition.",
        ),
    ] = False
    ...
    enable_character_encoding_fix: Annotated[
        bool,
        Field(
            description="Enable character encoding fix for corrupted text characters.",
        ),
    ] = False
