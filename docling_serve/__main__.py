...
def version_callback(value: bool) -> None:
    if value:
        ...
        console.print(f"Arabic Parser version: {docling_serve_version}")
...
def dev(
    *,
    ...
    """
    Run a [bold]Arabic Parser[/bold] app in [yellow]development[/yellow] mode. 🧪
...
def run(
    *,
    ...
    """
    Run a [bold]Arabic Parser[/bold] app in [green]production[/green] mode. 🚀
